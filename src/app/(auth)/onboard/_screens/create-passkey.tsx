...
import CreateWalletBtn from "../_components/create-wallet-btn";
...
const CreatePasskey = ({ nextStep }: { nextStep: () => void }) => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 text-white">
      <div className="flex w-full max-w-md flex-col items-center">
        ...
        <CreateWalletBtn phoneNumber={"+919876543210"} nextStep={nextStep} />
